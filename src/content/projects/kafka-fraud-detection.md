...
period: '2024'
purpose: 'Scores transactions for fraud while they are still moving through the stream, rather than in a batch job afterwards.'
contribution: 'Sole author. Built the whole pipeline: transaction generation, the Kafka topology, the inference stage, and the monitoring view.'
